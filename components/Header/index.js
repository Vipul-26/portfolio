...
class Header extends React.PureComponent {
  constructor() {
    super();
    this.state = {
      scrollDirection: "none", // none | up | down
      lastScrollTop: 0,
      isMenuOpen: false,
    };
  }
  ...
  /* 🔥 NEW: Fade-out / Fade-in + slide */
  getHeaderStyle = () => {
    const { scrollDirection } = this.state;

    return {
      height: "80px",
      transform: `translateY(${scrollDirection === "down" ? "-70px" : "0"})`,
      boxShadow:
        ...
        <style>
          {`
            .${styles.hamburgerInner}{
                ...
                transform: rotate(${isMenuOpen ? "225deg" : "0"}) !important;
